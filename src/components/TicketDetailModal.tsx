      ...
      <div className="bg-slate-900 border border-slate-800 w-full max-w-2xl rounded-3xl p-8 shadow-2xl relative">
        ...
        <div className="grid grid-cols-2 gap-8 border-t border-slate-800 pt-8">
          <div className="space-y-6">
            <div>
              <label className="block text-[10px] font-black text-slate-600 uppercase mb-1 tracking-widest">
                Current Status
              </label>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <span
                className={`text-[10px] font-black uppercase ${ticket.approvalStatus === "Approved" ? "text-emerald-400" : ticket.approvalStatus === "Rejected" ? "text-rose-400" : "text-slate-500"}`}
              >
        ...
        <div className="mt-10 flex justify-end gap-3 flex-wrap">
          ...
          <button
            onClick={onClose}
            className="px-8 py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl transition uppercase tracking-widest text-[10px]"
          >
            Close Details
          </button>
          {isAdmin && (
