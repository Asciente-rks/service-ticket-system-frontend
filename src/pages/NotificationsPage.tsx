    ...
    <div className="max-w-5xl mx-auto p-4 md:p-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm font-medium mt-2">Managing your workflow updates and ticket assignments</p>
        </div>
      ...
      <div className="bg-slate-900/50 border border-slate-800/60 rounded-[2rem] overflow-hidden backdrop-blur-xl shadow-2xl">
        {loading ? (
          <div className="p-32 text-center">
            ...
            <p className="text-slate-500 font-mono text-xs tracking-[0.3em] uppercase">Syncing alerts...</p>
          </div>
        ) : notifications.length === 0 ? (
          <div className="p-32 text-center">
            <div className="text-4xl mb-4 opacity-20">📭</div>
            <p className="text-slate-500 text-sm font-medium italic">Your notification history is empty.</p>
          </div>
        ) : (
